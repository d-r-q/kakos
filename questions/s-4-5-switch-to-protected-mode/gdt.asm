...
gdt_code: ; code segment descriptor
  ...
  ; type flags: (code)1 (conformin)0 (readable)1 (accessed)0 -> 1010b
...
; Define some handy constants for the GDT segment descriptor offsets, which are what
; segment registers must contain when in protected mode. For example, when we set 
; DS = 0x10 in PM, the CPU knows that we mean it to use the segment described at
